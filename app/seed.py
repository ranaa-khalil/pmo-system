...
def seed():
    ...
    persona_data = [
        {"name": "Platform Admin", "role": "DevOps Lead", "description": "Manages cloud infrastructure, users, and system configurations.", "goals": "Provision resources quickly, monitor system health, enforce security policies.", "pain_points": "Manual provisioning is slow, limited visibility into resource usage."},
        {"name": "End Customer", "role": "Business Lead", "description": "Consumes cloud services and submits support requests.", "goals": "Request resources easily, track request status, access self-service portal.", "pain_points": "Complex request forms, no real-time status updates."},
        {"name": "Account Manager", "role": "Product Owner", "description": "Manages client relationship, contracts, and commercial aspects.", "goals": "Track service usage, manage SLAs, generate reports for client.", "pain_points": "No centralized dashboard for client metrics, manual reporting."},
        {"name": "DevOps Engineer", "role": "DevOps Engineer", "description": "Deploys and maintains cloud infrastructure components.", "goals": "Automate deployments, monitor health, respond to incidents quickly.", "pain_points": "Manual deployments, no CI/CD pipeline visibility."},
        {"name": "QA Tester", "role": "QA Engineer", "description": "Tests the platform across environments before releases.", "goals": "Verify all features work as expected, report bugs clearly.", "pain_points": "Test data setup is manual, no automated regression suite."},
        {"name": "Product Owner", "role": "Product Owner", "description": "Owns the product vision and prioritizes the backlog.", "goals": "Deliver value to users every release, maintain a clear roadmap.", "pain_points": "Shifting priorities, limited visibility into dev progress."},
        {"name": "Engineering Team", "role": "Engineering Team", "description": "Builds and maintains the platform features.", "goals": "Write clean, testable code, deliver on sprint commitments.", "pain_points": "Technical debt, unclear requirements."},
        {"name": "CX Engineer", "role": "CX Engineer", "description": "Ensures a seamless customer experience across touchpoints.", "goals": "Reduce friction in user journeys, gather feedback.", "pain_points": "Limited user analytics, no in-app feedback channel."},
    ]

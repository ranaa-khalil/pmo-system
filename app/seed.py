...
def seed():
    ...
    persona_data = [
        ...
        {"name": "Support Agent", "role": "Customer Support", "description": "Handles incoming support tickets and user inquiries.", "goals": "Resolve issues quickly, maintain high CSAT.", "pain_points": "No unified ticketing view, repetitive manual tasks."},
    ]
